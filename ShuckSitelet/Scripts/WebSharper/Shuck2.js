(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Html,Client,Default,List,Shuck2,Client1,EventsPervasives,Remoting,AjaxRemotingProvider,Concurrency;
  ...
  Shuck2:{
   Client:{
    ...
    Start:function(input,k)
    {
     ...
     {
      var x,f1;
      x=AjaxRemotingProvider.Async("Shuck2:0",[input]);
      f1=function(_arg1)
      {
       var x1;
       x1=k(_arg1);
 ...
 Runtime.OnInit(function()
 {
  ...
  Shuck2=Runtime.Safe(Global.Shuck2);
  Client1=Runtime.Safe(Shuck2.Client);
